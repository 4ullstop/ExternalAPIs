...
cl %commonCompilerFlags% ..\code\memory_pools.cpp /LD /link /EXPORT:PushStruct /EXPORT:PushArray /EXPORT:PoolAlloc /EXPORT:ClearArena /EXPORT:PushArraySized /EXPORT:InitializeArena
