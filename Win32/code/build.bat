...
cl %commonCompilerFlags% ..\code\win32_framework.cpp /LD /link %commonLinkerFlags% /EXPORT:Win32ProcessKeyboardMessage /EXPORT:Win32ProcessMouseMessage /EXPORT:Win32ProcessPendingMessages
