...
cl %commonCompilerFlags% ..\code\game_framework.cpp /LD /link /EXPORT:CreateViewAndPerspective /EXPORT:GameUpdateCamera /EXPORT:LoadGameOBJFiles %commonLinkerFlags% 
